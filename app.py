...
<p> "Text number-" %s " text"</p>
<p>The complete source for the Breast Cancer Prediction can be found at:
<a href="https://github.com/Pratyush-exe/breast-cancer-detector-app">Breast Cancer Detector</a></p>
<p class="notice">Disclaimer: text.</p>
